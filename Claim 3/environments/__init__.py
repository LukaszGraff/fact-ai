...
register(id='RandomMOMDP-v0', entry_point='environments.random_momdp:RandomMOMDP', max_episode_steps=100)

register(id='RandomMOMDP-v1', entry_point='environments.random_momdp_terminate:RandomMOMDP', max_episode_steps=100)
